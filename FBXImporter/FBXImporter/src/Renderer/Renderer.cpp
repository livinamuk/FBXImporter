...
void Renderer::Init() {
    ...
    FBXImporter::LoadFile("res/models/RightHook.fbx", &_skinnedModel);
...
void Renderer::RenderFrame() {
    ...
    Transform transform;
    transform.rotation.y = HELL_PI * -0.5;
    transform.position.x = 2.85f;
    transform.position.y = 0.2f;
    transform.position.z = 3.6f;
    ...
    for (Mesh& mesh : _skinnedModel._meshes) {
        mesh.Draw();
    }
